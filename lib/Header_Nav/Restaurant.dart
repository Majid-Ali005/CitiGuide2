    ...
    return ListView(
      ...
      children: [
        ...
        PlaceCard(
          ...
          description: "Monal is a restaurant located in Islamabad, Pakistan. It is built on the Margalla Hills, which is a part of the Margalla Hills National Park, and offers a panoramic view of Islamabad.",
          rating: 4.5,
          reviews: 120,
        ),
        SizedBox(height: 16),
        PlaceCard(
          ...
          description: "Kolachi is a restaurant located in Karachi, Pakistan. It is known for its delicious BBQ and Pakistani cuisine.",
          rating: 4.8,
          reviews: 200,
        ),
        SizedBox(height: 16),
        PlaceCard(
          ...
          description: "Marco Polo Hotel is a luxury hotel located in Dubai, UAE. It offers premium services and a comfortable stay.",
          rating: 4.7,
          reviews: 150,
        ),
        SizedBox(height: 16),
        PlaceCard(
          ...
          title: "Kababjees Restaurant",
          description: "Kababjee's is a restaurant located in Lahore, Pakistan. It is known for its delicious kababs and Pakistani cuisine.",
          rating: 4.9,
          reviews: 300,
        ),
        SizedBox(height: 16),
        PlaceCard(
          imageUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTmnGeUKb-sM8TEG4Df4emTcUNPORhbHA8d8Q&s",
          title: "Cooco's Den",
          description: "Cooco's Den is a restaurant located in Lahore, Pakistan. It is built in a historic haveli and offers a unique dining experience.",
          rating: 4.6,
          reviews: 180,
        ),
      ],
