    ...
    return ListView(
      ...
      children: [
        ...
        PlaceCard(
          ...
          title: "Luxury Hotel",
          description: "Experience world-class amenities and breathtaking views.",
          rating: 4.5,
          reviews: 120,
        ),
        SizedBox(height: 16),
        PlaceCard(
          ...
          description: "Pearl Continental Hotel is a luxurious hotel in Pakistan.",
          rating: 4.8,
          reviews: 200,
        ),
        SizedBox(height: 16),
        PlaceCard(
          ...
          title: "Cozy Hotel",
          description: "Enjoy a comfortable stay with delicious breakfast.",
          rating: 4.7,
          reviews: 150,
        ),
        SizedBox(height: 16),
        PlaceCard(
          ...
          title: "Visa Luxury Hotel",
          description: "Indulge in luxury and premium services.",
          rating: 4.9,
          reviews: 300,
        ),
        SizedBox(height: 16),
